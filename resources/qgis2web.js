...
map.getView().fit([-8335782.312077, 4994155.609090, -8313958.881331, 5008384.553479], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Allamuchy Trails</h2>';
        return titleElement;
    })(),
